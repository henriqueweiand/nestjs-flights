...
export class Generated1732824425490 implements MigrationInterface {
    name = 'Generated1732824425490'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."federated_identity_provider_enum" AS ENUM('GITHUB', 'GOOGLE')`);
        await queryRunner.query(`CREATE TABLE "federated_identity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider" "public"."federated_identity_provider_enum" NOT NULL, "data" json NOT NULL, "create_dtm" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "modify_dtm" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_be34b3846fcf7528596cc388643" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."federated_identity_provider_enum"`);
    }
